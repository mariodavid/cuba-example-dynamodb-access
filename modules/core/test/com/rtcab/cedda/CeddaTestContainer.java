...
public class CeddaTestContainer extends TestContainer {

    public CeddaTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/rtcab/cedda/app.properties",
    ...
    public static class Common extends CeddaTestContainer {

        public static final CeddaTestContainer.Common INSTANCE = new CeddaTestContainer.Common();
